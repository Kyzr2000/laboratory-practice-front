...
import { CREATE_EXPERIENCE } from '@/pages/experience-management/graphql/experienceGql';
import AddressSelector from '@/pages/experience-management/components/AddressSelector';
...
const AddExperienceModal = ({ refreshData, user }: AddExperienceModalProps) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const { address, detailAddress, name, startDate, endDate } = values;
